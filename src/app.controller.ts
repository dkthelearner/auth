...
import { IAuthPayload, IGetUserById } from './types';
...
export class AppController {
    ...
    public async getUserByToken(@Payload() data: string): Promise<User | JwtPayload | string> {
    ...
    @Put('/change-password')
    changePassword(@Body() data: ForgotPasswordDto, @CurrentUser() auth: number): Promise<void> {
